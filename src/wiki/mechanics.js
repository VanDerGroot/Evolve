...
export function mechanicsPage(content){
    ...
    { // Offline Progress
        infoBoxBuilder(mainContent,{ name: 'offline', template: 'mechanics', label: loc('wiki_mechanics_offline'), paragraphs: 4, break: [4], h_level: 2,
            para_data: {
                1: [2,loc('wiki_mechanics_offline')],
                2: [loc('wiki_mechanics_offline')],
                3: [loc('wiki_mechanics_offline')],
                4: [24,loc('wiki_mechanics_offline')]
            }
        });
